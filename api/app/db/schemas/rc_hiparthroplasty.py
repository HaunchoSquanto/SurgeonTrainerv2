"""
Hip Arthroplasty Surgical schemas - Pydantic models for API request/response validation
"""
...
class RcHipArthroplastySurgicalBase(BaseModel):
    """Base hip arthroplasty surgical fields (research-focused)"""
    encounter_id: int
...
class RcHipArthroplastySurgicalCreate(RcHipArthroplastySurgicalBase):
    """Schema for creating a new hip arthroplasty surgical case"""
    pass


class RcHipArthroplastySurgicalUpdate(BaseModel):
    """Schema for updating a hip arthroplasty surgical case - all fields optional"""
...
class RcHipArthroplastySurgicalResponse(RcHipArthroplastySurgicalBase):
    """Schema for hip arthroplasty API response"""
    id: int
    created_at: datetime
