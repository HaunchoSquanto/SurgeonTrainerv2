"""
Shoulder Scope Surgical schemas - Pydantic models for API request/response validation
"""
...
class RcShoulderScopeSurgicalBase(BaseModel):
    """Base shoulder scope surgical fields"""
    encounter_id: int
...
class RcShoulderScopeSurgicalCreate(RcShoulderScopeSurgicalBase):
    """Schema for creating a new shoulder scope surgical case"""
    pass


class RcShoulderScopeSurgicalUpdate(BaseModel):
    """Schema for updating shoulder scope surgical - all fields optional"""
    fellow_or_pa: Optional[str] = None
    attending: Optional[str] = None
    mrn: Optional[str] = None
    first_name: Optional[str] = None
...
class RcShoulderScopeSurgicalResponse(RcShoulderScopeSurgicalBase):
    """Schema for shoulder scope surgical API response"""
    id: int
    created_at: datetime
