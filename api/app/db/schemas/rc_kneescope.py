"""
Knee Surgical schemas - Pydantic models for API request/response validation
"""
...
class RcKneeSurgicalBase(BaseModel):
    """Base knee surgical fields (research-focused)"""
    encounter_id: int
...
class RcKneeSurgicalCreate(RcKneeSurgicalBase):
    """Schema for creating a new knee surgical case"""
    pass


class RcKneeSurgicalUpdate(BaseModel):
    """Schema for updating a knee surgical case - all fields optional"""
...
class RcKneeSurgicalResponse(RcKneeSurgicalBase):
    """Schema for knee surgical API response"""
    id: int
    created_at: datetime
